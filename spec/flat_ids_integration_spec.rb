...
describe 'Search Integration Tests' do
  ...
  #
  it { pods.search('platform:osx').size.should == 108 }
  ...
  it { pods.search('platform:osx').size.should == 108 }
  it { pods.search('on:osx').size.should == 108 }
